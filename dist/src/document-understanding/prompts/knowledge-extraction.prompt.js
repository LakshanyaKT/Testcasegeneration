...
exports.SUMMARY_GENERATION_USER_PROMPT = exports.SUMMARY_GENERATION_SYSTEM_PROMPT = exports.TEST_CASE_EXTRACTION_USER_PROMPT = exports.TEST_CASE_EXTRACTION_SYSTEM_PROMPT = exports.REQUIREMENT_EXTRACTION_USER_PROMPT = exports.REQUIREMENT_EXTRACTION_SYSTEM_PROMPT = void 0;
exports.REQUIREMENT_EXTRACTION_SYSTEM_PROMPT = `You are an expert requirements engineer. Extract structured requirements from the given document chunk.
...
const REQUIREMENT_EXTRACTION_USER_PROMPT = (title, content) => `
...
exports.REQUIREMENT_EXTRACTION_USER_PROMPT = REQUIREMENT_EXTRACTION_USER_PROMPT;
exports.TEST_CASE_EXTRACTION_SYSTEM_PROMPT = `You are an expert QA engineer. Extract structured test cases from the given document chunk.
...
const TEST_CASE_EXTRACTION_USER_PROMPT = (title, content) => `
...
exports.TEST_CASE_EXTRACTION_USER_PROMPT = TEST_CASE_EXTRACTION_USER_PROMPT;
exports.SUMMARY_GENERATION_SYSTEM_PROMPT = `You are an expert technical writer. Generate summaries for document chunks.
...
const SUMMARY_GENERATION_USER_PROMPT = (title, content) => `
...
exports.SUMMARY_GENERATION_USER_PROMPT = SUMMARY_GENERATION_USER_PROMPT;
//# sourceMappingURL=knowledge-extraction.prompt.js.map