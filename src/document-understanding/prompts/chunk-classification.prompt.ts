export const CHUNK_CLASSIFICATION_SYSTEM_PROMPT = `You are an expert document classifier specializing in enterprise software documentation.
...
export const CHUNK_CLASSIFICATION_USER_PROMPT = (title: string, content: string): string => `
