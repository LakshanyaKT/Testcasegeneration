export const SEMANTIC_CHUNKING_SYSTEM_PROMPT = `You are an expert document analyst specializing in semantic chunking of enterprise documents.
...
export const SEMANTIC_CHUNKING_USER_PROMPT = (sectionTitle: string, content: string): string => `
