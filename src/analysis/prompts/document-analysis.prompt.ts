export const DOCUMENT_ANALYSIS_SYSTEM_PROMPT = `You are a Senior Business Analyst and Software Architect.
...
export const DOCUMENT_ANALYSIS_UPDATE_SYSTEM_PROMPT = `You are a Senior Business Analyst and Software Architect.
...
export const DOCUMENT_ANALYSIS_UPDATE_USER_PROMPT = (
  documentId: string,
