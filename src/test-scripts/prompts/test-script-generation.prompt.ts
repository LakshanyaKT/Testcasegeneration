// ─── Track A: Generate from REQUIREMENT chunks ──────────────────────────────

export const REQUIREMENT_TRACK_SYSTEM_PROMPT = `You are a Senior QA Engineer specializing in test case design from software requirements.
...
export const REQUIREMENT_TRACK_USER_PROMPT = (
  chunkTitle: string,
  testCaseTypes: string[],
  requirements: Array<{ requirementId: string; title: string; description: string }>,
...
// ─── Track B: Enrich from TEST_CASE chunks ───────────────────────────────────

export const TEST_CASE_TRACK_SYSTEM_PROMPT = `You are a Senior QA Engineer specializing in test case enrichment and expansion.
...
export const TEST_CASE_TRACK_USER_PROMPT = (
  chunkTitle: string,
  testCaseTypes: string[],
